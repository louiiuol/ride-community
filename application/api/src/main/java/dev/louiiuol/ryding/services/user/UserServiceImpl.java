package dev.louiiuol.ryding.services.user;
...
import dev.louiiuol.ryding.api.dtos.users.UserCreateDto;
import dev.louiiuol.ryding.api.dtos.users.UserUpdateDto;
import dev.louiiuol.ryding.api.dtos.users.UserViewDetailsDto;
import dev.louiiuol.ryding.api.dtos.users.UserViewDto;
import dev.louiiuol.ryding.api.exceptions.ResourceNotFoundException;
import dev.louiiuol.ryding.business.entities.User;
import dev.louiiuol.ryding.business.repositories.UserRepository;
import dev.louiiuol.ryding.services.role.RoleService;
...
public class UserServiceImpl extends AbstractService<User, UserRepository>
    ...
    public UserDetails loadUserByUsername(String username) {
        ...
        return new dev.louiiuol.ryding.business.entities.UserDetails(user); // Return custom version of Spring's UserDetails entity
    }
